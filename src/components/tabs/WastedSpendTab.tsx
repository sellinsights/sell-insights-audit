...
const columns: Column<WastedSpendRow>[] = [
  ...
  { key: "count", header: "Search Term Count", align: "right", render: (r) => formatNumber(r.searchTermCount) },
  { key: "minClicks", header: "Min Clicks", align: "right", render: (r) => formatNumber(r.minClicks) },
  { key: "maxClicks", header: "Max Clicks", align: "right", render: (r) => formatNumber(r.maxClicks) },
